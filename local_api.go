...
type TurnDetail struct {
	...
	// is non-empty and has no leading or trailing whitespace, while accepted bytes
	// are preserved exactly. Producers enforce the assistant-only role condition;
	// generated shape validators do not infer it from Role.
