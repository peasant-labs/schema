...
func TypeCatalogEntries() []TypeCatalogEntry {
	return []TypeCatalogEntry{
		...
		{"VillageErrorResponse", new(schema.VillageErrorResponse)}, {"VillageGroup", new(schema.VillageGroup)},
		...
		{"VillagePublicGroup", new(schema.VillagePublicGroup)}, {"VillageRemoveGroupMemberResponse", new(schema.VillageRemoveGroupMemberResponse)},
