...
func TypeCatalogEntries() []TypeCatalogEntry {
	return []TypeCatalogEntry{
		...
		{"DiffHunk", new(schema.DiffHunk)}, {"DiffLine", new(schema.DiffLine)},
		...
		{"FileChange", new(schema.FileChange)},
		...
		{"TurnDetail", new(schema.TurnDetail)}, {"TypeOrigin", new(schema.TypeOrigin)},
