...
func TypeCatalogEntries() []TypeCatalogEntry {
	return []TypeCatalogEntry{
		...
		{"AnnotatorSummary", new(schema.AnnotatorSummary)}, {"AssociationEvidence", new(schema.AssociationEvidence)},
		{"AssociationKind", new(schema.AssociationKind)}, {"BatchCreateAnnotationsErrorResponse", new(schema.BatchCreateAnnotationsErrorResponse)},
